...
/**
 * Provides the local service interface for ABVersion. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ABVersionLocalServiceUtil
...
public interface ABVersionLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ABVersionLocalServiceUtil} to access the a b version local service. Add custom service methods to {@link com.liferay.content.targeting.report.campaign.newsletter.service.impl.ABVersionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
